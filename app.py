...
class StockMarketAnalysis:
    ...
    def load_data(self):
        ...
        # Adjust end_date to current date if it exceeds current date
        ...
        try:
            ...
            # Case 1: Entire requested period is within CSV data and before cutoff
            ...
            # Case 2: Requested period extends beyond cutoff or CSV data
                ...
                # Fetch yfinance data from csv_end to end_date if needed
                yf_start = csv_end if csv_end >= start_date else start_date
