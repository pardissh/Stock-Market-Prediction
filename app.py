...
class StockMarketAnalysis:
    ...
    def load_data(self):
        ...
        # Cap end_date to current date to avoid future data requests
        ...
        try:
            ...
            if start_date >= historical_start and end_date <= historical_end:
                ...
                logging.info(f"Date range {start_date.date()} to {end_date.date()} exceeds local data. Fetching from yfinance.")
