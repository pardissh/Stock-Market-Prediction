...
from yfinance.base import _UserAgentBasedScraper
...
class StockMarketAnalysis:
    ...
    def load_data(self):
        yf.base._UserAgentBasedScraper._DEFAULT_USER_AGENT = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36"
