...
st.write("Analyze stock prices with time series techniques (by Pardis Shoumali)")
...
# Footer
st.markdown("---")
st.write("**Team Contributions**: Pardis Shoumali (Sole Contributor)")
...
st.write("All code was written by Pardis Shoumali, using the above resources for reference.")