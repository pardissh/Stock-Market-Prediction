...
class StockMarketAnalysis:
    ...
    def load_data(self):
        ...
        try:
            ...
            # Check if the requested date range is fully covered by historical data
            ...
            if start_date >= historical_start and end_date <= historical_end:
                ...
                # Fetch from yfinance if date range exceeds local data
                ...
                # Merge with historical data if available, prioritizing yfinance for overlapping dates
            ...
            # Fallback to yfinance if local file is missing or insufficient
    ...
    def predict_future(self, order, steps=30):
        try:
            ...
            # Generate UTC-aware forecast dates
    ...
    def validate_model(self, train_data, validation_data, order, title):
        try:
            # Ensure train and validation data indexes are UTC-aware
...
end_date = st.date_input("End Date", value=pd.to_datetime("2019-01-05"))
